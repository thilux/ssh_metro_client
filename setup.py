...
setup(
    ...
    keywords='python pexpect ssh requests tunnel ssh-tunnel argparse',
    ...
    entry_points={
        "console_scripts": [
            "ssh_metro_client=sshmetroclient.main:main"
        ],
    },
    tests_require=test_requires,
    test_suite='test_metro_client',
